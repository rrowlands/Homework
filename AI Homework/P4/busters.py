...
def getObservationDistribution(noisyDistance):
    """
    Returns the factor P( noisyDistance | TrueDistances ) as a Counter dictionary
    for the provided noisyDistance.  It maps each possible true distance to
    the corresponding likelihood of the noisyDistance measurement given that true distance.
    """
